      ...
      <Container>
        ...
        <section id="catalog-results" className="scroll-mt-28">
          <SectionTitle
            ...
            description={
              hasQuery
                ? "Показываем только позиции из этой категории, которые подходят под поисковый запрос."
                : "Страница сфокусирована на товарах текущей категории без повторного выбора категории внутри интерфейса."
            }
          />
