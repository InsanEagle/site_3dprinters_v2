      ...
      <Container>
        ...
        <section id="catalog-results" className="scroll-mt-28">
          <SectionTitle
            ...
            description={
              hasQuery
                ? "Показываем только позиции из этой категории, которые подходят под поисковый запрос. В карточках сохраняется тот же direct-sale / marketplace / inquiry сценарий, что и на странице товара."
